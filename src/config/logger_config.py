"""Logger configuration for The Sokkatto

Configures logging for The Sokkatto bot, providing both file-based and console-based output with colored formatting.

Attributes:
    log_file (str): The path to the log file ("sokkatto.log").
...
Functions:
    configure_loggers: Configures loggers to follow The Sokkatto's logging format.
"""
